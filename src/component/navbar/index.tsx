            ...
            <nav className="bg-red-600 border-gray-200 font-semibold ">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="http://localhost:3000/#" className="flex items-center">
                        <img src="https://yt3.googleusercontent.com/ytc/AL5GRJWvxIxAuEpsbXBCv_COo5fa2yQQdytpGU0ZcS1R=s900-c-k-c0x00ffffff-no-rj" className="h-8 mr-3" alt="Flowbite Logo" />
                    </a>
                    <div>
                        <button>
                            <form className="flex items-center">
                                <div className="relative w-full">
                                    ...
                                    <input type="text"  className="bg-gray-50 border w-72  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='search, movie, TV, actors' required/>
                                </div>
